...
- Human verification: Done (2026-06-03) — rules published to the named database via the Firebase Console; creating and moving a VayBoard card works live with no PERMISSION_DENIED on normal actions.
- Manual operations: Console publish of `firestore.rules` to database `ai-studio-db4e1f11-7b01-482c-8858-c5f639421b94` (done 2026-06-03).
